...
<html lang="en">
  <head>
    ...
    <title>TambahTipeSuperior</title>
...
<h1>Tambah Fasilitas</h1>
    <div>
        <form action="/tambahgambar" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row justify-content-center p-4">
            <div>
                <h4>Nama Fasilitas</h4>
                <input type="text" id="Nama" name="Fasilitas_Hotel" placeholder='Nama Fasilitas' required autofocus>
            </div>
                <h4>Gambar</h4>
